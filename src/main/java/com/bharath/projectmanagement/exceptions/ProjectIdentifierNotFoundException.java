...
public class ProjectIdentifierNotFoundException extends RuntimeException{
    
	// This message would be sent from the service.
	public ProjectIdentifierNotFoundException(String message) {
